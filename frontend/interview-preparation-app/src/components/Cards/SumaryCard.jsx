    ...
    >
      ...
      <div className="px-3 pb-3">
        <div className="flex items-center gap-3 mt-4">
          ...
          <div className="text-[10px] text-black font-medium px-3 py-1 border-[0.5px] border-gray-900 rounded-full">
        ...
        <p className="text-[12px] text-gray-500 text-medium line-clamp-2 mt-3">
          {description}
        </p>
      </div>
    </div>
